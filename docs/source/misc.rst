...
Javascript registered
    ...
    def test_js_available(self):
        ...
        self.failUnless('BarackSlideshow.js' in script_ids)
        self.failUnless('Fx.MorphList.js' in script_ids)
        self.failUnless('mootools-1.2.1-core-yc.js' in script_ids)
        self.failUnless('mootools-1.2.2.2-more.js' in script_ids)
...
Product Installed
    ...
    def test_collective_plonetruegallery_installed(self):
        qi = getToolByName(self.portal, 'portal_quickinstaller')
        self.assertTrue(qi.isProductInstalled("collective.plonetruegallery"))
